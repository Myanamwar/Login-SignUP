...
//        addErrorPlaceholderLabel()
       ...
       self.font = UIFont.init(name: (self.font?.fontName ?? "helvetica")!, size: 16)
    }
    ...
    func addBottomLine(){
        ...
        let bottomConstraint = NSLayoutConstraint.init(item: bottomLineView!, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: -10)
    ...
    func floatPlaceHolder(selected:Bool) -> Void {
        ...
        labelPlaceholder?.font = UIFont(name: (self.font?.fontName)!, size: 15)
